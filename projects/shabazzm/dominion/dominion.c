...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
       return minePlay(choice1,choice2,handPos,currentPlayer,state);
    ...
    case baron:
	 return baronPlay(choice1,currentPlayer,state);
    ...
    case minion:
 	return minionPlay(choice1,choice2,handPos,currentPlayer,state);
    ...
    case tribute:
	return tributePlay(choice1, choice2,nextPlayer,handPos, currentPlayer,state, tributeRevealedCards);

    case ambassador:
 	return ambassadorPlay(choice1, choice2,handPos, currentPlayer,state);
