...
void addActions(struct gameState * state, int toAdd) {
    state->numActions += toAdd;
}

void addBuys(struct gameState * state, int toAdd) {
    state->numBuys += toAdd;
}
//the amabassadorEffect function performs the actions of the Ambassador card
...
//The baronEffect function runs the effect of the baron card when played
int baronEffect(struct gameState *state, int choice1, int currentPlayer)
{
    addBuys(state, 1);//Increase buys by 1!
...
//minionEffect implements the minion effects when that card is played
...
//the tributeEffect function implements the effects of the tribute card
...
//mineEffect implements the effects of the mine card
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
   ...
   // int tributeRevealedCards[2] = {-1, -1};
    ...
    case minion:
        return minionEffect(state, choice1, choice2, handPos, currentPlayer);
