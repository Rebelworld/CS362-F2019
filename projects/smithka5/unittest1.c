...
int main() {
    ...
    mineEffect(&testG,currentPlayer,choice1,choice2,handpos);
   ...
   mineEffect(&testG,currentPlayer,choice1,choice2,handpos);
    ...
    int m=mineEffect(&testG,currentPlayer,choice1,choice2,handpos);
    if(assertValues(m,-1))    
    {
    ...
    memcpy(&testG,&G,sizeof(struct gameState));
    choice2=-3;
    m=mineEffect(&testG,currentPlayer,choice1,choice2,handpos);
    if(assertValues(m,-1))
    {
